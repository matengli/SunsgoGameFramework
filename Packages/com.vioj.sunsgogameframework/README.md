...
<root>
  ...
  ├── Editor
  │   ├── Vioj.Sunsgogameframework.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Vioj.Sunsgogameframework.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Vioj.Sunsgogameframework.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Vioj.Sunsgogameframework.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Vioj.Sunsgogameframework`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package SunsgoGameFramework Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Vioj.Sunsgogameframework.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Vioj.Sunsgogameframework.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Vioj.Sunsgogameframework.Editor.Tests.asmdef`

  `Tests/Runtime/Vioj.Sunsgogameframework.Tests.asmdef`
...
Use the `Documentations~/SunsgoGameFramework.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
